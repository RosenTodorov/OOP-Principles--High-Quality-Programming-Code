...
class ExtendedInteractionManager : InteractionManager
{
    ...
    private Location DetermineActorLocation(Person actor)
    {
        Location currentLocation = personByName[actor.Name].Location;
...
{
    const int GenerlIronItemValue = 3;

    public IronItem(string name, Location location = null)
        : base(name, IronItem.GenerlIronItemValue, ItemType.Iron, location)
    {
...
{
    const int GeneralWoodItemValue = 2;

    public WoodItem(string name, Location location = null)
        : base(name, WoodItem.GeneralWoodItemValue, ItemType.Wood, location)
    {
    }
