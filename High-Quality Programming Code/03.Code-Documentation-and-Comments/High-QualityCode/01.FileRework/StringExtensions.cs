...
namespace Telerik.ILS.Common
{
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Checks if provided input contains some of pre-listed true-values
        ...
        /// <summary>
        /// Tries to parse the given input to short.
        /// </summary>
        /// <param name="input">Input strin</param>
        ...
        /// <summary>
        /// Tries to parse input string to out 32-bit signed integer
        /// </summary>
        /// <param name="input">Input string</param>
        ...
        /// <summary>
        /// Tries to parse input string to out 64-bit signed integer
        /// </summary>
        /// <param name="input">Input string</param>
        ...
        /// <summary>
        /// Tries to parse input string to out System.DateTime
        /// </summary>
        /// <param name="input">Input string</param>
        ...
        /// <summary>
        /// Turns the first letter of the input to capita, if the input itself
